...
// TODO PR #318: This test is commented out because it requires the TxBuilder, which we expect to
//               not be there by the time 4.0 ship. Re-write this test using the Wallet::create_psbt
//               workflow once #297 is in.
// #[test]
