...
/// let mut keyring = KeyRing::new(Network::Testnet, KeychainKind::External, P2Pkh(key_external))
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, P2Pkh(key_internal))
...
/// let key_internal =
///     bitcoin::PrivateKey::from_wif("cVpPVruEDdmutPzisEsYvtST1usBR3ntr8pXSyt6D2YYqXRyPcFW")?;
/// let mut keyring = KeyRing::new(Network::Testnet, KeychainKind::External, P2Wpkh_P2Sh(key_external))
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, P2Wpkh_P2Sh(key_internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
/// assert_eq!(
...
/// let key_internal =
///     bitcoin::PrivateKey::from_wif("cVpPVruEDdmutPzisEsYvtST1usBR3ntr8pXSyt6D2YYqXRyPcFW")?;
/// let mut keyring = KeyRing::new(Network::Testnet, KeychainKind::External, P2Wpkh(key_external))
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, P2Wpkh(key_internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
/// assert_eq!(
...
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, P2TR(key_internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
/// assert_eq!(
...
/// # use std::str::FromStr;
/// # use bdk_wallet::bitcoin::{PrivateKey, Network};
/// # use bdk_wallet::{Wallet, KeychainKind, KeyRing};
...
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, Bip44(key, KeychainKind::Internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
...
/// # use std::str::FromStr;
/// # use bdk_wallet::bitcoin::{PrivateKey, Network};
/// # use bdk_wallet::{KeychainKind, KeyRing, Wallet};
/// use bdk_wallet::template::Bip44Public;
///
/// let key = bitcoin::bip32::Xpub::from_str("tpubDDDzQ31JkZB7VxUr9bjvBivDdqoFLrDPyLWtLapArAi51ftfmCb2DPxwLQzX65iNcXz1DGaVvyvo6JQ6rTU73r2gqdEo8uov9QKRb7nKCSU")?;
/// let fingerprint = bitcoin::bip32::Fingerprint::from_str("c55b303f")?;
/// let mut keyring = KeyRing::new(Network::Testnet, KeychainKind::External, Bip44Public(key.clone(), fingerprint, KeychainKind::External))
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, Bip44Public(key, fingerprint, KeychainKind::Internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
...
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, Bip49(key, KeychainKind::Internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
...
/// let fingerprint = bitcoin::bip32::Fingerprint::from_str("c55b303f")?;
/// let mut keyring = KeyRing::new(Network::Testnet, KeychainKind::External, Bip49Public(key.clone(), fingerprint, KeychainKind::External))
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, Bip49Public(key, fingerprint, KeychainKind::Internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
...
/// let fingerprint = bitcoin::bip32::Fingerprint::from_str("c55b303f")?;
/// let mut keyring = KeyRing::new(Network::Testnet, KeychainKind::External, Bip84Public(key.clone(), fingerprint, KeychainKind::External))
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, Bip84Public(key, fingerprint, KeychainKind::Internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
...
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, Bip86(key, KeychainKind::Internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
...
/// let key = bitcoin::bip32::Xpub::from_str("tpubDC2Qwo2TFsaNC4ju8nrUJ9mqVT3eSgdmy1yPqhgkjwmke3PRXutNGRYAUo6RCHTcVQaDR3ohNU9we59brGHuEKPvH1ags2nevW5opEE9Z5Q")?;
/// let fingerprint = bitcoin::bip32::Fingerprint::from_str("c55b303f")?;
/// let mut keyring = KeyRing::new(Network::Testnet, KeychainKind::External, Bip86Public(key.clone(), fingerprint, KeychainKind::External))
///     .expect("valid descriptor");
/// keyring
///     .add_descriptor(KeychainKind::Internal, Bip86Public(key, fingerprint, KeychainKind::Internal))
///     .expect("valid change descriptor");
/// let mut wallet = Wallet::create(keyring).create_wallet_no_persist();
///
