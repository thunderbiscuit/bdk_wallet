...
/// Represents changes to the [`KeyRing`](crate::keyring::KeyRing).
...
{
    /// Schema name for [`KeyRing`](crate::keyring::KeyRing)
    ...
    /// Construct the [`KeyRing`](crate::keyring::KeyRing) from persistence
    ///
    ...
    /// Persist the [`KeyRing`](crate::keyring::KeyRing)
    ///
    /// Remember to call [`Self::init_sqlite_tables`] beforehand.
