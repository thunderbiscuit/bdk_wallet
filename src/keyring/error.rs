...
/// Error corresponding to [`KeyRing`](crate::keyring::KeyRing)
#[derive(Debug, PartialEq)]
pub enum KeyRingError<K> {
    /// The descriptors used to create/being added to [`KeyRing`](crate::keyring::KeyRing) are
    /// invalid
    Descriptor(crate::descriptor::error::Error),
    /// The keychain exists in the [`KeyRing`](crate::keyring::KeyRing) but mapped to a different
    /// descriptor
    KeychainAlreadyExists(K),
    /// The descriptor exists in the [`KeyRing`](crate::keyring::KeyRing) but mapped to a different
    /// keychain
